...
ActiveRecord::Schema[7.1].define(version: 2024_10_03_145806) do
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.datetime "last_before_date"
    t.datetime "oldest_before_date"
  end
  ...
  create_table "replay_stats", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["replay_id"], name: "index_replay_stats_on_replay_id"
  end
